         ...
         <div class="row">
            <div class="col-4 offset-2">
                    ...
                    <div class="form-group mt-3" >
                         ...
                         <input type="number" min="150" max="990" class="form-control form-control-lg " name="monthly"  placeholder="TND" required>
                    </div>
        ...
        <div class="row">
            <div class="offset-2 col-3">
                <div class="form-group mt-3" >
                    ...
                    <input type="number" max="10" min="0" class="form-control form-control-lg " name="bedrooms"required>
                </div>
           ...
           <h4 class="outfit offset-2 mt-3">Gender</h4>
            ...
            <div class="form-check form-check-inline offset-2">
              ...
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio"  id="both" value="Both" name="gender" required>
              ...
              <div class="row"> 
                <div class="col-6 offset-2">
                        <div class="form-group mt-2" >
                            ...
                            <input type="text" class="form-control form-control-lg " name="uni" required>
                       </div>
                </div>
            </div>
              <div class="row"> 
                <div class="col-6 offset-2">
                        <div class="form-group mt-2" >
                            <label for="location" class="form-label outfit"><h4>location(please provide an embed card from google maps)</h4></label>
                            <input type="text" class="form-control form-control-lg " name="location" required>
                       </div>
                </div>
            </div>
            <div class="form-group mt-6 col-6 offset-2" id="p">
              <label for="property" class="form-label outfit" > <h5>property type :</h5></label>
...
<h4 class="outfit offset-2 mt-3">Pictures (please choose 3)</h4>              
              <input type="file" name="multiPartServlet1" accept="image/*" 
                   onchange="readFilesAndDisplayPreview(this.files);" /> <br/> 
            
            <input type="file" name="multiPartServlet2" accept="image/*" 
                   onchange="readFilesAndDisplayPreview(this.files);" /> <br/> 
            
            <input type="file" name="multiPartServlet3" accept="image/*" 
                   onchange="readFilesAndDisplayPreview(this.files);" /> <br/> 
            </div>
            <div class="row">
                <div class="col-4 offset-2">
            <h4 class="outfit   mt-3">Notes(optional) </h4>
           <textarea name="note"  cols="30" rows="10"  class=" form-control" placeholder="enter additional information" ></textarea>
        </div>
        </div>
        ...
        <div class="row">
            <div class="offset-8 col-5 mt-5">
                <input type="submit" style="margin-top:0.5cm"  class="btn btn-info btn-lg btn-blocck rounded-pill" value="publish" name="myBtn">
            </div>
        </div>
        </div>
