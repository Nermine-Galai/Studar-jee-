                ...
                <div class="col-md-5 col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
    <form action="Controller" class="col">
        <input type="hidden" name="houseId" value="${house.houseId}">
        <button class="btn btn-warning col-6 offset-1" type="submit" name="myBtn" value="Update">Update</button>
    </form>
    <form action="Controller" class="col">
        <input type="hidden" name="houseId" value="${house.houseId}">
                      <input type="hidden" name="email" value="${sessionScope.activeUser.email}">
        
        <button class="btn btn-danger col-6 offset-1" type="submit" name="myBtn" value="Delete">Delete</button>
    </form>
</div>
